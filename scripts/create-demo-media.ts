...
// Run after downloading the licensed originals documented in docs/MEDIA.md into /tmp/aurelia-media.
async function main() {
...
const icon='<svg xmlns="http://www.w3.org/2000/svg" width="128" height="128"><rect width="128" height="128" rx="20" fill="#341f1c"/><text x="64" y="84" text-anchor="middle" font-family="Georgia" font-size="65" fill="#eee5d6">CA</text></svg>';
