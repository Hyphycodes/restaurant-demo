...
export const REFERENCE_REQUIREMENT_TYPES: Row[] = [
  requirement(REQUIREMENT_IDS.welcome, { slug: 'welcome', title: 'Welcome to Cosa Nostra', description: 'Read the welcome note and what to expect in your first week.', category: 'handbook', kind: 'acknowledgement', required: true, onboarding: true, sort: 0 }),
  ...
  requirement(REQUIREMENT_IDS.foodHandler, { slug: 'food-handler', title: 'Food handler certificate', description: 'Upload your certificate. Required for kitchen and food-running positions where Cosa Nostra policy says so.', category: 'certification', kind: 'upload', required: false, onboarding: true, sort: 90, expires_after_days: 1095, applies_to_positions: ['kitchen', 'server', 'busser'] }),
  requirement(REQUIREMENT_IDS.basset, { slug: 'basset', title: 'BASSET / alcohol service', description: 'Upload your BASSET card. Whether it is required per position is an Cosa Nostra policy setting.', category: 'certification', kind: 'upload', required: false, onboarding: true, sort: 100, expires_after_days: 1095, applies_to_positions: ['bartender', 'server', 'manager'] }),
