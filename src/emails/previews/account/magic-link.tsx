...
export default function MagicLinkPreview() {
  return <MagicLink brand={brand} name="Nico Moretti" email="alex@example.com" actionUrl="https://restaurant-demo.vercel.app/auth/callback?code=preview" expiresInMinutes={60} />;
}
